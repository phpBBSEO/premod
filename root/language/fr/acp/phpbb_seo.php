...
$lang = array_merge($lang, array(
	...
	'SEO_LOGIN_SESSION'		=> 'La vérification de session à échouée.<br/>Aucune modification prise en compte.<br/>Votre session à été détruite pour des raisons de sécurité.',
	// Cache status
	...
	// Seo advices
	'SEO_ADVICE_DUPE'	=> 'Un duplicata de ce titre à été détecté pour une URL de forum : <b>%1$s</b>.<br/>Vous devez utiliser un titre et une URL unique pour chaque forum.',
	'SEO_ADVICE_RESERVED'   => 'Une URL réservée (utilisée par les posts, les profiles ou les parties statiques des autres urls) a été détectée dans l’url du forum : <b>%1$s</b>.<br/>Son URL est restée inchangée.',
	...
	'profile_vfolder_explain' => 'Vous pouvez simuler une structure en dossier virtuels pour les profils et les pages des messages des membres (optionel voir plus bas), <b>phpBB/pseudo-uxx/(topics/)</b> or <b>phpBB/membrexx/(topics/)</b> au lieux de <b>phpBB/pseudo-uxx(-topics).html</b> and <b>phpBB/membrexx(-topics).html</b>.<br/><b style="color:red">Nota Bene :</b><br/><ul style="margin-left:20px">L’option "Profiles sans ID" impose cette option.<br/>La modification de cette option requiert une mise à jour de votre .htaccess.</ul>',
