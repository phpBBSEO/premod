...
$lang = array_merge($lang, array(
	...
	'sql_rewrite_explain' => 'Permet d’activer les url personnalisées pour les sujets. Vous pourrez alors choisir une url précise pour chaque sujet, soit au moment de le créer, soit en éditant simplement celui-ci. Cette possibilité est toutefois réservée aux administrateurs du forum. <br/><br/><b style="color:red">Nota Bene :</b><br/><ul style="margin-left:20px">Si l’activation de cette option est sans conséquence en mode avancé, les URL étant alors stockées telles qu’elles dans la base de donnée, ce n’est pas la cas en mode intermédiaire et simple.<br/>Les url de sujets type <b>sujetxx.html</b> seront alors progressivement redirigées vers <b>sujet-txx.html</b> afin de permettre l’injection d’une url personnalisée à la demande.<br/>Cela implique donc de nombreuses redirections et ne doit pas être mis en place avant un minimum de tests et de réflexion. Si vous ne voulez pas d’injection de mot clés dans les urls des sujets, n’activez pas cette option.<br/><br/>L’option a également le mérite de rendre beaucoup plus rapide la réécriture avec dossier virtuels et de permettre une récupération bien plus simple des url récrites depuis n’importe quelle page.</ul>',
