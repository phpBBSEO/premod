<?php
/**
* acp_permissions_phpbb (phpBB Permission Set) [Standard french]
...
// User Permissions
$lang = array_merge($lang, array(
	'acl_u_viewprofile'	=> array('lang' => 'Peut voir les profils, la liste des membres et la liste des utilisateurs connectés.', 'cat' => 'profile'),
	...
	'acl_u_viewonline'	=> array('lang' => 'Peut voir les utilisateurs invisibles connectés.', 'cat' => 'misc'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_edit'		=> array('lang' => 'Peut modifier un de ses messages.', 'cat' => 'actions'),
	...
	'acl_f_subscribe'	=> array('lang' => 'Peut surveiller ce forum.', 'cat' => 'actions'),
	...
	'acl_f_search'		=> array('lang' => 'Peut rechercher dans ce forum.', 'cat' => 'misc'),
...
$lang = array_merge($lang, array(
	'acl_m_edit'		=> array('lang' => 'Peut modifier un message.', 'cat' => 'post_actions'),
...
$lang = array_merge($lang, array(
	...
	'acl_a_user'		=> array('lang' => 'Peut gérer les membres.<br /><em>Ceci inclut également l’affichage du navigateur des utilisateurs dans la liste des utilisateurs connectés.</em>.', 'cat' => 'user_group'),
	'acl_a_userdel'		=> array('lang' => 'Peut supprimer/trier les membres.', 'cat' => 'user_group'),
	...
	'acl_a_authusers'	=> array('lang' => 'Peut modifier les permissions des membres.', 'cat' => 'permissions'),
