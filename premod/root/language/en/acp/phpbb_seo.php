...
$lang = array_merge($lang, array(
	...
	'ACP_NO_FORUM_URL'	=> '<b>Forum URL Management disabled<b><br/>The forum URL management is only available in advanced and Mixed mode and when Forum URL caching is actyivated.<br/>Forum URLs already configured will stay active in advanced and Mixed mode.',
	// ACP sub Cat
